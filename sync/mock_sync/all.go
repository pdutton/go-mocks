...
// Source: github.com/pdutton/go-interfaces/sync (interfaces: Cond,Locker,Map,Mutex,Once,Pool,RWMutex,Sync,WaitGroup)
//
// Generated by this command:
//
//	mockgen -destination sync/mock_sync/all.go github.com/pdutton/go-interfaces/sync Cond,Locker,Map,Mutex,Once,Pool,RWMutex,Sync,WaitGroup
//
...
import (
	...
	sync "github.com/pdutton/go-interfaces/sync"
...
func (m *MockRWMutex) RLocker() sync0.Locker {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RLocker")
	ret0, _ := ret[0].(sync0.Locker)
	return ret0
}
...
// NewCond mocks base method.
func (m *MockSync) NewCond(arg0 sync0.Locker) sync.Cond {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewCond", arg0)
	ret0, _ := ret[0].(sync.Cond)
	return ret0
}

// NewCond indicates an expected call of NewCond.
func (mr *MockSyncMockRecorder) NewCond(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// NewMap indicates an expected call of NewMap.
func (mr *MockSyncMockRecorder) NewMap() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewMap", reflect.TypeOf((*MockSync)(nil).NewMap))
}

// NewMutex mocks base method.
func (m *MockSync) NewMutex(arg0 ...sync.MutexOption) sync.Mutex {
	m.ctrl.T.Helper()
	varargs := []any{}
	for _, a := range arg0 {
...
func (mr *MockSyncMockRecorder) NewMutex(arg0 ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewMutex", reflect.TypeOf((*MockSync)(nil).NewMutex), arg0...)
}

// NewOnce mocks base method.
func (m *MockSync) NewOnce() sync.Once {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewOnce")
	ret0, _ := ret[0].(sync.Once)
	return ret0
}

// NewOnce indicates an expected call of NewOnce.
func (mr *MockSyncMockRecorder) NewOnce() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewOnce", reflect.TypeOf((*MockSync)(nil).NewOnce))
}

// NewPool mocks base method.
func (m *MockSync) NewPool(arg0 ...sync.PoolOption) sync.Pool {
	m.ctrl.T.Helper()
	varargs := []any{}
	for _, a := range arg0 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "NewPool", varargs...)
	ret0, _ := ret[0].(sync.Pool)
	return ret0
}

// NewPool indicates an expected call of NewPool.
func (mr *MockSyncMockRecorder) NewPool(arg0 ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewPool", reflect.TypeOf((*MockSync)(nil).NewPool), arg0...)
}

// NewRWMutex mocks base method.
func (m *MockSync) NewRWMutex(arg0 ...sync.RWMutexOption) sync.RWMutex {
	m.ctrl.T.Helper()
	varargs := []any{}
	for _, a := range arg0 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "NewRWMutex", varargs...)
	ret0, _ := ret[0].(sync.RWMutex)
	return ret0
}

// NewRWMutex indicates an expected call of NewRWMutex.
func (mr *MockSyncMockRecorder) NewRWMutex(arg0 ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewRWMutex", reflect.TypeOf((*MockSync)(nil).NewRWMutex), arg0...)
}

// NewWaitGroup mocks base method.
func (m *MockSync) NewWaitGroup(arg0 ...sync.WaitGroupOption) sync.WaitGroup {
	m.ctrl.T.Helper()
	varargs := []any{}
	for _, a := range arg0 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "NewWaitGroup", varargs...)
	ret0, _ := ret[0].(sync.WaitGroup)
	return ret0
}

// NewWaitGroup indicates an expected call of NewWaitGroup.
func (mr *MockSyncMockRecorder) NewWaitGroup(arg0 ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewWaitGroup", reflect.TypeOf((*MockSync)(nil).NewWaitGroup), arg0...)
}

// OnceFunc mocks base method.
func (m *MockSync) OnceFunc(arg0 func()) func() {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "OnceFunc", arg0)
	ret0, _ := ret[0].(func())
	return ret0
}

// OnceFunc indicates an expected call of OnceFunc.
func (mr *MockSyncMockRecorder) OnceFunc(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "OnceFunc", reflect.TypeOf((*MockSync)(nil).OnceFunc), arg0)
}
