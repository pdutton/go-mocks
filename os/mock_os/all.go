...
// Source: github.com/pdutton/go-interfaces/os (interfaces: File,OS,Process,Root)
//
// Generated by this command:
//
//	mockgen -destination os/mock_os/all.go github.com/pdutton/go-interfaces/os File,OS,Process,Root
//
