...
// Source: github.com/pdutton/go-interfaces/net/http (interfaces: Client)
//
// Generated by this command:
//
//	mockgen -destination net/http/mock_http/client.go github.com/pdutton/go-interfaces/net/http Client
//
